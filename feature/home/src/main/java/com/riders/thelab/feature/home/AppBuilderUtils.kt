...
import com.riders.thelab.feature.transitions.chooser.TransitionsChooserActivity
...
/*
            ...
            .also { Timber.d("getMobileActivities() | size: ${it.size}") }
            .toList()

    // TODO : handle non existing activities for TV
    fun getTVActivities(context: Context): List<App> =
        mutableListOf<App>()
            .apply {
                // Artists
                this.add(artists)
