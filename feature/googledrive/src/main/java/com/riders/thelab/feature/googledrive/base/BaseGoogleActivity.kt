package com.riders.thelab.feature.googledrive.base
...
abstract class BaseGoogleActivity : BaseComponentActivity() {
                    ...
                    task
                        ...
                        .addOnCompleteListener {
                            if (!task.isSuccessful) {
                                ...
                                if (account != null) {
                                    GoogleSignInManager.getInstance(this).setGoogleAccount(account)
                                    GoogleDriveManager.getInstance(this)
                                        .initializeDriveClientLegacy(account)
                                }
                            }
                        }
                }
