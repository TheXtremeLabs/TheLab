...
@Composable
fun MLKitChooserContent(theme: AppTheme, darkTheme: Boolean) {
...
@DevicePreviews
@Composable
private fun PreviewMLKitChooserContent(@PreviewParameter(AppThemePreviewProvider::class) appTheme: AppTheme) {
    TheLabTheme(theme = appTheme) {
        MLKitChooserContent(theme = appTheme, darkTheme = isSystemInDarkTheme())
    }
}
