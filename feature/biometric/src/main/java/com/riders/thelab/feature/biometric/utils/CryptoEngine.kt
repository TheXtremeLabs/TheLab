package com.riders.thelab.feature.biometric.utils

import android.security.keystore.KeyGenParameterSpec
import android.security.keystore.KeyPermanentlyInvalidatedException
import android.security.keystore.KeyProperties
import androidx.biometric.BiometricPrompt.CryptoObject
import com.riders.thelab.core.data.local.model.biometric.EncryptDataResult
...
class CryptoEngine {
    ...
    private fun generateKeyWithResult(): ValidationResult {
        Timber.d("generateKeyWithResult()")
        return try {
            generateTargetKey()
            ValidationResult.OK
        } catch (ex: Exception) {
