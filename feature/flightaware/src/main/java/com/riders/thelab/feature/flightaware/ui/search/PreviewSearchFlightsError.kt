...
///////////////////////////////////////
@Composable
fun SearchFlightsErrorContent(theme: AppTheme, darkTheme: Boolean, reason: NotBlankString) {
...
@DevicePreviews
@Composable
private fun PreviewSearchFlightsError(@PreviewParameter(AppThemePreviewProvider::class) appTheme: AppTheme) {
