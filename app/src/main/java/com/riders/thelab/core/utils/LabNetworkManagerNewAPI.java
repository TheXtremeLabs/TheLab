...
public class LabNetworkManagerNewAPI extends ConnectivityManager.NetworkCallback {

    private static boolean isConnected = false;
    ConnectivityListener listener;

    public LabNetworkManagerNewAPI(ConnectivityListener listener) {
    ...
    private void createUrlConnectionCall(String targetUrl,
                                         boolean withProgressCallback,
                                         @Nullable WeatherLiveDataHelper liveDataHelper) {
