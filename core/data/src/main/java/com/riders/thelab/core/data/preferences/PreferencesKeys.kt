...
object PreferencesKeys {
    ...
    // APP
    val DATASTORE_FIRST_TIME_LAUNCHED_KEY =
        booleanPreferencesKey("DATASTORE_FIRST_TIME_LAUNCHED_KEY")
    val DATASTORE_DARK_MODE_KEY = booleanPreferencesKey("DATASTORE_DARK_MODE_KEY")
    val DATASTORE_APP_THEME_NAME = stringPreferencesKey("DATASTORE_APP_THEME_NAME")
