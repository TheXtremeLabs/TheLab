...
import com.riders.thelab.core.common.interceptors.LabOkHttpLoggingInterceptor
...
internal object ApiModule {
    ...
    fun provideWeatherOkHttp(isBulkDownload: Boolean = false): OkHttpClient = OkHttpClient.Builder()
        ...
        .addInterceptor(LabOkHttpLoggingInterceptor(isBulkDownload).provideOkHttpLogger())
        .build()
    ...
    fun provideTMDBOkHttp(): OkHttpClient = OkHttpClient.Builder()
        ...
        .addInterceptor(LabOkHttpLoggingInterceptor().provideOkHttpLogger())
        .build()
    ...
    fun provideRetrofit(url: String): Retrofit = Retrofit.Builder()
        ...
        .addConverterFactory(Constants.json.asConverterFactory(Constants.CONTENT_TYPE_JSON.toMediaType()))
        .build()
    ...
    @Provides
    @Singleton
    fun provideArtistsAPIService(): ArtistsAPIService = provideRetrofitArtists(
        com.riders.thelab.core.data.utils.Constants.BASE_ENDPOINT_GOOGLE_FIREBASE_API
    ).create(ArtistsAPIService::class.java)


    @Provides
    @Singleton
    fun provideGoogleAPIService(): GoogleAPIService = provideRetrofit(
        com.riders.thelab.core.data.utils.Constants.BASE_ENDPOINT_GOOGLE_MAPS_API
    ).create(GoogleAPIService::class.java)


    @Provides
    @Singleton
    fun provideYoutubeApiService(): YoutubeApiService = provideRetrofit(
        com.riders.thelab.core.data.utils.Constants.BASE_ENDPOINT_YOUTUBE
    ).create(YoutubeApiService::class.java)


    @Provides
    @Singleton
    fun provideWeatherApiService(): WeatherApiService = provideWeatherRetrofit(
        com.riders.thelab.core.data.utils.Constants.BASE_ENDPOINT_WEATHER
    ).create(WeatherApiService::class.java)


    @Provides
    @Singleton
    fun proWeatherBulkApiService(): WeatherBulkApiService = provideWeatherBulkRetrofit(
        com.riders.thelab.core.data.utils.Constants.BASE_ENDPOINT_WEATHER_BULK_DOWNLOAD
    ).create(WeatherBulkApiService::class.java)


    @Provides
    @Singleton
    fun provideUserAPIService(): TheLabBackApiService = provideRetrofit(
        com.riders.thelab.core.data.utils.Constants.BASE_ENDPOINT_THE_LAB_URL
    ).create(TheLabBackApiService::class.java)

    @Provides
    @Singleton
    fun provideSpotifyAccountAPIService(): SpotifyAccountAPIService = provideRetrofit(
        com.riders.thelab.core.data.utils.Constants.BASE_ENDPOINT_SPOTIFY_ACCOUNT
    ).create(SpotifyAccountAPIService::class.java)


    @Provides
    @Singleton
    fun provideSpotifyAPIService(): SpotifyAPIService = provideRetrofit(
        com.riders.thelab.core.data.utils.Constants.BASE_ENDPOINT_SPOTIFY_API
    ).create(SpotifyAPIService::class.java)


    @Provides
    @Singleton
    fun provideTMDBAPIService(): TMDBApiService = provideTMDBRetrofit(
        com.riders.thelab.core.data.utils.Constants.BASE_ENDPOINT_TMDB_API
    ).create(TMDBApiService::class.java)

    @Provides
    @Singleton
    fun provideFlightAPIService(): FlightApiService = provideFlightRetrofit(
        com.riders.thelab.core.data.utils.Constants.BASE_ENDPOINT_FLIGHT_AWARE_API
    ).create(FlightApiService::class.java)

    @Provides
    @Singleton
    fun provideWikimediaAPIService(): WikimediaApiService = provideWikimediaRetrofit(
        com.riders.thelab.core.data.utils.Constants.BASE_ENDPOINT_WIKIMEDIA_API
