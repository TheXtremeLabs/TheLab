package com.riders.thelab.core.speechtotext.di
...
object VoiceAssistantModule {
    ...
    ): Credentials = GoogleSpeechCredentialsProvider(context).credentials
    ...
    fun provideSpeechClient(@ApplicationContext context: Context): SpeechClient {
        ...
        SpeechStubSettings.newBuilder()
            ?.apply {
                credentialsProvider = GoogleSpeechCredentialsProvider(context)
    ...
    ): ISpeechToTextRepository = SpeechToTextRepository(speechClient)
}